...
int updateWT(int PID, PCB queue[100])
{
                ...
                switch ( algorithmID ) {
                    ...
                    case 4:
                        ...
                        if(readyQueue[0].burst > qt)
                        {
                            ...
                            readyQueue[lenReadyQueue].wt = updateWT(readyQueue[0].PID,readyQueue);
                            sleep(qt);
